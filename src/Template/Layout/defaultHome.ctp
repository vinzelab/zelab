...
<head>
  ...
  <?= $this->Html->meta('keywords','entrez vos mots clés pour la balise meta ici');?>
  <?= $this->Html->meta('description','entrez vodescription ici');?>
  <title>
    <?= $cakeDescription ?>:
    <?= $this->fetch('title') ?>
  </title>
...
<body>
  ...
  <div class="extra-work">
    <h1 class="masking">Graphic & web <br />designer</h1>
  </div>
  <div class="scroll-wrapper">
    <a href="#activity"><div class="scroll-icon"><span></span></div></a>
  </div>
</header>
