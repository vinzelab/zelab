...
$cakeDescription = 'Zelab- Portfolio of Vincent ZERBIB Graphic & Webdesigner';
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="logo-zelab-auth">
      ...
      <div class="admin-navbar">
        <?= $this->Html->link(__("<i class='ion-settings'>Projets</i>"),'/projects/admin',['class' => 'btn btn-default', 'escape' => false]); ?>
        <?= $this->Html->link(__("<i class='ion-ios-people'>partenaires</i>"),'/partners/admin',['class' => 'btn btn-default', 'escape' => false]); ?>
        <?= $this->Html->link(__("<i class='ion-ios-cog'>Utilisateurs</i>"),'/users/add',['class' => 'btn btn-default', 'escape' => false]); ?>
        <?= $this->Html->link(__("<i class='ion-earth'>Accéder au site</i>"),'/projects',['class' => 'btn btn-default', 'escape' => false]); ?>
      </div>
    </div>
