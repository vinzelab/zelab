<header class="container-fluid">
  ...
  <nav class="container desktop-menu">
    <ul>
      ...
      <li><a href="http://localhost:8888/zelab/partner.html">Partners</a></li>
      <li><a href="http://localhost:8888/zelab/category-project.html" >Projects</a></li>
      <li><a href="">Extras</a></li>
      <li><a href="http://localhost:8888/zelab/contact.html">Contact</a></li>
      <li><a href="https://dribbble.com/vinzzerbib" ><i class="fa fa-dribbble" aria-hidden="true"></i></a></li>
      <li><a href="https://fr.pinterest.com/vinzerb/" ><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
      <li><a href="https://fr.pinterest.com/vinzerb/" ><i class="fa fa-behance" aria-hidden="true"></i></a></li>
    </ul>
  </nav>
  <!-- MENU STICKY -->
  <div class="sticky-header hide">
    <nav>
      <ul>
        <li><a href="http://localhost:8888/zelab"><img src="img/zelab-sticky.png" alt="logo zelab" /></a></li>
        <li><a href="">The lab</a></li>
        <li><a href="">Skills</a></li>
        <li><a href="http://localhost:8888/zelab/partner.html">Partners</a></li>
        <li><a href="http://localhost:8888/zelab/category-project.html">Projects</a></li>
        <li><a href="">Extras</a></li>
        <li><a href="http://localhost:8888/zelab/contact.html">Contact</a></li>
        <li><a target="_blank" href="https://dribbble.com/vinzzerbib"><i class="fa fa-dribbble" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://fr.pinterest.com/vinzerb/"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://fr.pinterest.com/vinzerb/"><i class="fa fa-behance" aria-hidden="true"></i></a></li>
      </ul>
    </nav>
  </div>
...
<div class="overlay" id="overlay">
  ...
  <h1>Graphic and Webdesign agency</h1>
  <button type="button" name="discover" class="zelab-button">Discover</button>
  <div class="scroll-header"><a href="#activity"<i class="ion-ios-arrow-down"></i></a></div>
</header>
<section id="activity">
...
<div class="activities-icons container">
  ...
  <button type="button" name="project" class="zelab-button">Check our skills</button>
</section>
<section id="work">
...
<div class="container-fluid work-grid">
  <div class="work">
    <?php foreach ($projects as $project): ?>
      <?= $this->Html->link($project->project_title, ['action' => 'view', $project->id]) ?>

    <!-- <img src="img/portfolio/coqarl_thumbnail.jpg" alt="le coq et l'arlequin" />
    <div class="portfolio-title">
      <h3>LE Coq & l'Arlequin</h3>
      <p>Web development</p> -->
    <?php endforeach; ?>
    </div>
  </div>
<button type="button" name="project" class="zelab-button">See all</button>
</section>
<?= $this->fetch('content') ?>
